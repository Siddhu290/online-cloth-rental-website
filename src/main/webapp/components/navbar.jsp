...
<div class="container-fluid">
  <a class="navbar-brand" href="index.jsp"><h3><i>Reworn revival clothing</i></h3></a>
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px;">
          <b>
            ...
            When an order is placed, the product will be dispatched from the vendor’s inventory with per-addressed packaging. There should also be a provision for holding an insurance amount during the rental period to cover any sort of accidental damage.<br>
            <br> Transactions have been going on all over the world
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="images/phonee.png" style="width:27px;" alt="img">123456789<br>
                <img src="images/emaill.png" style="width:29px;" alt="img">rewonreviavalcloths123@gmail.com
            </b>
        </p>
        </div>
      </div>
